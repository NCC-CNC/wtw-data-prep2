create_project_folder <- function(project_dir) {
  ...
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "themes", "species")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "themes", "species", "eccc_ch")))
  )
  suppressWarnings(
  ...
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "themes", "species", "nsc_end")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "themes", "species", "nsc_sar")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "themes", "species", "nsc_spp")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "themes", "habitat")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "themes", "agriculture")))
  )
  suppressWarnings((dir.create(file.path(project_dir, "tifs", "weights"))))
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "weights", "carbon")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "weights", "climate")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "weights", "connectivity")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "weights", "eservices")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "weights", "habitat")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "weights", "pressures")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "weights", "hotspots")))
  )
  suppressWarnings(
    (dir.create(file.path(project_dir, "tifs", "weights", "tenure")))
  )
